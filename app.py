  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/alexkamene/Cv-marcher-/blob/main/Untitled2.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "outputId": "4796be55-926c-49c5-9e3f-44e9f64762c3"
      },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "21eChLjUuMdH",
        "outputId": "83b757fd-328b-4e5c-c90d-f4f5c0642a4f"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "import time\n",
        "\n",
        "# Kill any process running on port 8501 to avoid conflicts\n",
        "!kill $(lsof -t -i:8501) || echo \"No process to kill\"\n",
        "\n",
      ...
      "metadata": {
        ...
        "id": "quL9okzZ5bTG",
        "outputId": "12108cf0-def6-4182-ce68-2c1edef0389c"
      },
      "execution_count": null,
      "outputs": [
        {
        ...
        },
        {
          ...
          "name": "stdout",
          "text": [
            "Streamlit app is live at: NgrokTunnel: \"https://e622-35-236-210-223.ngrok-free.app\" -> \"http://localhost:8501\"\n"
          ]
        }
      ]
    },
